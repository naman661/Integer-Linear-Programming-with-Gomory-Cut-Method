...
def iteration(A1,basis_indices):
    ...
    while(not dual_unbounded and not optimal):
        ...
        if tempo1:
            print("here dual unbounded: ",A[pivot_row_index])
            dual_unbounded = True
...
# A1 = [[0,1,1,0,0],[-2,-1,-2,1,0],[-1,-1,0,0,1]]
# A,b = iteration(A1,[2,3])
# print(A)
# print(b)
...
def simplex_iteration(A, b, C, m: int, n: int,is_auxillary,Answer_dictionary,Global_B,Global_Basis):
    ...
    if(is_auxillary!=1):  
      ...
      Answer_dictionary["initial_tableau"]=(np.round(Down_Table_initial,7))
      # print("-----------------------------------------------")
    ...
    while(MaxRC > eps):
      ...
      if (Index_Leave == -1):
        ...
        Answer_dictionary["final_tableau"]=(np.round(Down_Table_final,7))
        # print("-----------------------------------------------")
...
def cutting_plane(A1,basis_indices):
    ...
    while(not optimal and not dual_unbounded):
        ...
        for i in range(len(A)):
           for j in range(len(A[0])):
              A[i][j] = round(A[i][j],7)
        # tempA1 = copy.deepcopy(A)
        # tempA1 = np.array(tempA1)
        # print("here1A: ",tempA1)
        ...
        if A == "dual_unbounded":
            ...
            for i in range(len(A)):
                for j in range(len(A[0])):
                    A[i][j] = round(A[i][j],7)
            # tempA2 = copy.deepcopy(A)
            # tempA2 = np.array(tempA2)
            # print("here2A: ",tempA2)
    ...
    if optimal:
        ...
        # print("optimum_cost: ",-1*A[0][0])
        ans_dict["optimal_value"] = round(-1*A[0][0])

        # print("number of cuts: ",n-n1)
...
def helper():
    ...
    for i in range(len(Initial_tableau)):
       for j in range(len(Initial_tableau[0])):
          Initial_tableau[i][j] = round(Initial_tableau[i][j],7)


    print()
    print("...................................................")
    print("Initial_Tableau: ",Initial_tableau)
    print("...................................................")
    print()
    ...
    if solution_status == "infeasible":
        ...
        print(initial_solution[len(initial_solution)-1])
    ...
    if solution_status == "optimal":
        ...
        print("number_og_cuts: " + str(number_of_cuts))
